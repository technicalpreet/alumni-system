<?php
include 'db.php';
if(isset($_SESSION["uname"])  && isset($_SESSION["rollNo"]) && isset($_SESSION["branch"])) {
    $uname = $_SESSION["uname"];
    $rolln= $_SESSION["rollNo"] ;
}
$qry = "SELECT * FROM `student_details` WHERE rollno='$rolln'";
// echo $qry;
...
<DIV class="container-fluid mb-2" style="background-color:#336699;">
    <DIV class="row">
     ...
     margin-left: 20px;
     float:left;
     line-height:90px;">Alumni System</h1>
        </DIV>
        <DIV class="col-md-4">
            <div class="dropdown mt-2" style="float:right;">
                <button class="btn dropdown-toggle btnHover"  type="button" data-toggle="dropdown" aria-expanded="false">
                    <?php echo "<img class='rounded-circle mr-2' src='uploads/" . $pho . "' width=50 height=50>"; ?><?php echo "Welcome<br>$uname"; ?>
                </button>
                <p>
